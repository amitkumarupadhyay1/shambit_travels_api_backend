    ...
    @extend_schema(
        ...
        request=inline_serializer(
            ...
            fields={
                ...
                'first_name': serializers.CharField(help_text='User first name', required=False),
                'last_name': serializers.CharField(help_text='User last name', required=False),
                ...
                'token': serializers.CharField(help_text='OAuth access token for verification'),
            }
        ),
        responses={
