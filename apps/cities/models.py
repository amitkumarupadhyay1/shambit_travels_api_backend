...
class Highlight(models.Model):
    city = models.ForeignKey(City, related_name='highlights', on_delete=models.CASCADE, db_index=True)
...
class TravelTip(models.Model):
    city = models.ForeignKey(City, related_name='travel_tips', on_delete=models.CASCADE, db_index=True)
    title = models.CharField(max_length=200)
