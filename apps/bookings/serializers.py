...
from packages.serializers import (
    PackageSerializer, ExperienceSerializer, 
    HotelTierSerializer, TransportOptionSerializer
)
...
class BookingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Booking
        fields = [
            'id', 'user_email', 'package', 'selected_experiences',
            'selected_hotel_tier', 'selected_transport', 'total_price',
...
class BookingCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Booking
        fields = [
            'package_id', 'selected_experience_ids', 
            'hotel_tier_id', 'transport_option_id'
        ]
