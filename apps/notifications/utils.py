...
class NotificationUtils:
    ...
    def send_realtime_notification(
        notification: Notification, extra_data: Optional[Dict[str, Any]] = None
    ):
        """
...
def notify_booking_update(booking, status_change: str):
    ...
    return NotificationUtils.create_and_send_notification(
        ...
        message=message_map.get(
            status_change, f"Your booking status has been updated to {status_change}."
        ),
...
def notify_payment_update(payment, status_change: str):
    ...
    return NotificationUtils.create_and_send_notification(
        ...
        message=message_map.get(
            status_change, f"Your payment status has been updated to {status_change}."
        ),
