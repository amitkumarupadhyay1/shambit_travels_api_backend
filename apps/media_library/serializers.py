...
class MediaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Media
        fields = [
            'id', 'file', 'file_url', 'file_size', 'file_type', 'is_image',
            'image_dimensions', 'alt_text', 'title', 'content_type', 
            'object_id', 'content_type_name', 'content_object_str', 'created_at'
        ]
        read_only_fields = ['id', 'created_at', 'file_url', 'file_size', 
                           'file_type', 'is_image', 'image_dimensions']
...
class MediaListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Media
        fields = [
            'id', 'file_url', 'file_type', 'title', 'alt_text',
