...
class SEOAnalyzer:
    ...
    def analyze_seo_data(self, seo_data: SEOData) -> Dict[str, Any]:
        ...
        analysis = {
            ...
            "keywords_count": (
                len(seo_data.keywords.split(",")) if seo_data.keywords else 0
            ),
    ...
    def _generate_recommendations(
        self, seo_data: SEOData, analysis: Dict[str, Any]
    ) -> List[str]:
        """
        ...
        if analysis["keywords_score"] == "missing":
            recommendations.append(
                "Add relevant keywords to help with search visibility"
            )
            ...
            recommendations.append(
                "Too many keywords - focus on 3-10 most relevant terms"
            )

        # Open Graph recommendations
        if analysis["og_completeness"] < 0.5:
            recommendations.append(
                "Improve Open Graph data for better social media sharing"
            )
...
class StructuredDataGenerator:
    ...
    def _generate_article_schema(self, article) -> Dict[str, Any]:
        ...
        schema = {
            ...
            "publisher": {"@type": "Organization", "name": "Travel Platform"},
            "datePublished": (
    ...
    def _generate_package_schema(self, package) -> Dict[str, Any]:
        ...
        schema = {
            ...
            "brand": {"@type": "Organization", "name": "Travel Platform"},
        }
...
class SEOUtils:
    ...
    def generate_meta_tags(seo_data: SEOData, canonical_url: str = "") -> str:
        ...
        if seo_data.og_image:
            tags.append(
                f'<meta name="twitter:image" content="{seo_data.og_image.url}">'
            )
    ...
    def validate_seo_data(seo_data: Dict[str, Any]) -> Dict[str, List[str]]:
        ...
        if not description:
            ...
            warnings.append(
                "Meta description is shorter than recommended (120-160 characters)"
            )
        elif len(description) > 160:
            warnings.append(
                "Meta description is longer than recommended (120-160 characters)"
            )
