...
class SEODataAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Analysis", {"fields": ("seo_analysis",), "classes": ("collapse",)}),
    )
                ...
                try:
                    ...
                    if object_ids:
                        ...
                        for obj_id in object_ids:
                            try:
                                SEOService.generate_seo_from_content(
                                    content_type, obj_id
                                )
                                created_count += 1
                        ...
                        self.message_user(
                            request, "No objects missing SEO data found.", messages.INFO
                        )
