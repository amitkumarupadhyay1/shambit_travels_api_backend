...
class SEODataSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'content_object_str', 'title', 'description', 'keywords',
            'og_title', 'og_description', 'og_image', 'structured_data'
        ]
...
class SEODataListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SEOData
        fields = [
            'id', 'content_type_name', 'content_object_str', 
...
class SEODataCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SEOData
        fields = [
            'content_type', 'object_id', 'title', 'description', 
...
class SEODataUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'og_description', 'og_image', 'structured_data'
        ]
...
class SEOMetaTagsSerializer(serializers.Serializer):
    ...
    def to_representation(self, instance):
        ...
        if data.get('description'):
            meta_tags.append(f'<meta name="description" content="{data["description"]}">')
...
class StructuredDataSerializer(serializers.Serializer):
    ...
    def validate_schema_type(self, value):
        ...
        valid_types = [
            ...
            'Organization', 'LocalBusiness', 'TravelAgency', 'TouristDestination',
            'TouristAttraction', 'Hotel', 'Restaurant', 'Event', 'Product',
            'Service', 'Review', 'Rating', 'BreadcrumbList'
        ]
