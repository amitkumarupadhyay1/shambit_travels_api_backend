...
from .serializers import PackageSerializer, ExperienceSerializer, HotelTierSerializer, TransportOptionSerializer
...
class PackageViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return Package.objects.select_related('city').prefetch_related(
            'experiences',
            'hotel_tiers', 
            'transport_options'
    ...
    @extend_schema(
        ...
        parameters=[
            OpenApiParameter(
                ...
                examples=[
                    OpenApiExample('Mumbai Heritage Tour', value='mumbai-heritage-tour'),
    ...
    @extend_schema(
        ...
        request=inline_serializer(
            ...
            fields={
                ...
                'hotel_tier_id': serializers.IntegerField(help_text='Selected hotel tier ID'),
                'transport_option_id': serializers.IntegerField(help_text='Selected transport option ID'),
            }
        ),
        responses={
            200: inline_serializer(
        ...
        examples=[
            ...
            OpenApiExample(
                ...
                value={
                    ...
                    'breakdown': {
                        'experiences': [
                            {'id': 1, 'name': 'Gateway of India Tour', 'price': '2500.00'},
                            {'id': 3, 'name': 'Marine Drive Walk', 'price': '1500.00'},
                            {'id': 5, 'name': 'Bollywood Studio Visit', 'price': '4000.00'}
                        ],
                        'hotel_tier': {
                            'id': 2,
                            'name': '4-Star Hotels',
    ...
    def calculate_price(self, request, slug=None):
        ...
        try:
            ...
            transport_option = get_object_or_404(TransportOption, id=transport_option_id)
            ...
            hotel_multiplied = (base_experience_price + transport_price) * hotel_tier.price_multiplier
