...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='transportoption',
            index=models.Index(fields=['base_price_per_day'], name='packages_tra_base_pr_idx'),
        ),
        migrations.AddIndex(
            model_name='transportoption',
            index=models.Index(fields=['is_active', 'base_price_per_day'], name='packages_tra_is_acti_idx'),
        ),
    ]
