...
class Experience(models.Model):
    ...
    base_price = models.DecimalField(max_digits=10, decimal_places=2, db_index=True)  # Price filtering
...
class HotelTier(models.Model):
    ...
    description = models.TextField()
    price_multiplier = models.DecimalField(max_digits=4, decimal_places=2, default=1.0, db_index=True)
...
class Package(models.Model):
    city = models.ForeignKey(City, related_name='packages', on_delete=models.CASCADE, db_index=True)
    name = models.CharField(max_length=200, db_index=True)  # Frequently searched
    ...
    class Meta:
        indexes = [
            ...
            models.Index(fields=['is_active', 'created_at']),  # Active packages ordered by date
